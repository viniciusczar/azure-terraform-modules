module "postgresql-server" {
  ...
  # Configurações do servidor e banco de dados PostgreSQL
  postgresqlserver_name = "tf-postgresqldbsrv01"

  postgresqlserver_settings = {
    ...
    database_name = "demopostgresqldb"
  ...
  # Parâmetros do servidor PostgreSQL
  # Mais informações em: https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/concepts-server-parameters
  postgresql_configuration = {
    backslash_quote = "on"
  }

  # Administrador AD para um servidor Azure PostgreSQL
  # Permite definir um usuário ou grupo existente do AD como administrador para um servidor SQL do Azure
  # ad_admin_principal_name = "firstname.lastname@example.com"
  # ad_admin_principal_type = "ServicePrincipal"

  # Criar User Assigned Identity para ser gerente administrador do Active Directory em um PostgreSQL Flexible Server
  ...
  # (Opcional) Para habilitar o monitoramento do Azure para o banco de dados Azure PostgreSQL
  ...
  storage_account_name                   = "tfpostgresqllogdignostics"
  ...
  azurerm_private_dns_zone_name = "tf.privatelink.postgres.database.azure.com"
