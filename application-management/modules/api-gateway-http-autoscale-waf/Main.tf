module "application-gateway" {
  ...
  # Configuração do WAF, grupos de regras desativados e exclusions.depends_on
  # O Application Gateway WAF vem pré-configurado com CRS 3.0 por padrão. Mas você pode optar por usar o CRS 3.2, 3.1 ou 2.2.9.
  # O CRS 3.2 está disponível apenas no SKU `WAF_v2`.
  waf_configuration = {
